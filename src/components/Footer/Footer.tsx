        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p className="footer-description">
              ...
              מעל 5 שנות ניסיון, זמינות 24/7 ואחריות מלאה על כל עבודה.
            </p>
            <div className="footer-social">
              <a href="https://wa.me/972545907677" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="WhatsApp">
              ...
              <a href="tel:+972-54-590-7677" className="social-link" aria-label="Phone">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <button onClick={() => scrollToSection('why-choose-me')} className="footer-link">
                  למה לבחור בנו
                </button>
              </li>
              <li>
          ...
          <div className="footer-section">
            <h4 className="footer-subtitle">פרטי התקשרות</h4>
            <ul className="footer-contact">
              <li>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                </svg>
                <a href="tel:+972-54-590-7677">054-590-7677</a>
              </li>
              <li>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
